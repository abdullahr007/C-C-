 ...
 * 
 * Iterates from the start of the queue to the end and prints every item
 * in the queue with spacec between them ending on a new line character
 * 
 * @param pq The pointer to the queue sturcture
 */
